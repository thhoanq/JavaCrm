            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Danh sách nhân viên trong project</h4>
                    </div>
                	<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                       <a href="<c:url value="/insert_user_project?pro_id=${project.getId() }"/>" class="btn btn-sm btn-success">Thêm mới</a>
                   	</div>                  		  
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                    ...
                                    <tbody>                                        
                                        <c:forEach var="us" items="${users }">		
	                                        <tr>
	                                            ...
	                                            <td>                                            	                                          		                                                
		                                        	<a href="<c:url value="/api/deleta_user_project?id_delete=${us.getId() }" />" class="btn btn-sm btn-danger">Xóa</a>
	                                            </td>
	                                        </tr> 
                                        </c:forEach>
                                    </tbody>
